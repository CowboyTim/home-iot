...
sub modbus_open_uart {
    ...
    # TCSETSW 115200, 8N1
    # c_iflag, see asm-generic/termbits.h
    use constant     IGNBRK   => 0000001;
    use constant     BRKINT   => 0000002;
    use constant     IGNPAR   => 0000004;
    use constant     PARMRK   => 0000010;
    use constant     INPCK    => 0000020;
    use constant     ISTRIP   => 0000040;
    use constant     INLCR    => 0000100;
    use constant     IGNCR    => 0000200;
    use constant     ICRNL    => 0000400;
    use constant     IUCLC    => 0001000;
    use constant     IXON     => 0002000;
    use constant     IXANY    => 0004000;
    use constant     IXOFF    => 0010000;
    use constant     IMAXBEL  => 0020000;
    use constant     IUTF8    => 0040000;
    # c_oflag, see asm-generic/termbits.h
    use constant     OPOST    => 0000001;
    use constant     ONLCR    => 0000002;
    use constant     OCRNL    => 0000004;
    use constant     ONOCR    => 0000010;
    use constant     ONLRET   => 0000020;
    use constant     OFILL    => 0000040;
    use constant     OFDEL    => 0000100;
    use constant     NLDLY    => 0000200;
    use constant     NL0      => 0000000;
    use constant     NL1      => 0000200;
    use constant     CRDLY    => 0003000;
    use constant     CR0      => 0000000;
    use constant     CR1      => 0001000;
    use constant     CR2      => 0002000;
    use constant     CR3      => 0003000;
    use constant     TABDLY   => 0014000;
    use constant     TAB0     => 0000000;
    use constant     TAB1     => 0004000;
    use constant     TAB2     => 0010000;
    use constant     TAB3     => 0014000;
    use constant     BSDLY    => 0020000;
    use constant     BS0      => 0000000;
    use constant     BS1      => 0020000;
    use constant     FFDLY    => 0100000;
    use constant     FF0      => 0000000;
    use constant     FF1      => 0100000;
    use constant     VTDLY    => 0040000;
    use constant     VT0      => 0000000;
    use constant     VT1      => 0040000;
    use constant     XTABS    => 0014000;
    # c_cflag, see asm-generic/termbits.h
    use constant     CBAUD    => 0010017;
    use constant     B0       => 0000000;
    use constant     B50      => 0000001;
    use constant     B75      => 0000002;
    use constant     B110     => 0000003;
    use constant     B134     => 0000004;
    use constant     B150     => 0000005;
    use constant     B200     => 0000006;
    use constant     B300     => 0000007;
    use constant     B600     => 0000010;
    use constant     B1200    => 0000011;
    use constant     B1800    => 0000012;
    use constant     B2400    => 0000013;
    use constant     B4800    => 0000014;
    use constant     B9600    => 0000015;
    use constant     B19200   => 0000016;
    use constant     B38400   => 0000017;
    use constant     CSIZE    => 0000060;
    use constant     CS5      => 0000000;
    use constant     CS6      => 0000020;
    use constant     CS7      => 0000040;
    use constant     CS8      => 0000060;
    use constant     CSTOPB   => 0000100;
    use constant     CREAD    => 0000200;
    use constant     PARENB   => 0000400;
    use constant     PARODD   => 0001000;
    use constant     HUPCL    => 0002000;
    use constant     CLOCAL   => 0004000;
    use constant     CBAUDEX  => 0010000;
    use constant     BOTHER   => 0010000;
    use constant     B57600   => 0010001;
    use constant     B115200  => 0010002;
    use constant     B230400  => 0010003;
    use constant     B460800  => 0010004;
    use constant     B500000  => 0010005;
    use constant     B576000  => 0010006;
    use constant     B921600  => 0010007;
    use constant     B1000000 => 0010010;
    use constant     B1152000 => 0010011;
    use constant     B1500000 => 0010012;
    use constant     B2000000 => 0010013;
    use constant     B2500000 => 0010014;
    use constant     B3000000 => 0010015;
    use constant     B3500000 => 0010016;
    use constant     B4000000 => 0010017;
    use constant     CIBAUD   => 002003600000; # 0010000
    use constant     CMSPAR   => 010000000000;
    use constant     CRTSCTS  => 020000000000;
    use constant     IBSHIFT  => 16;

    # c_lflag, see asm-generic/termbits.h
    use constant     ISIG     => 0000001;
    use constant     ICANON   => 0000002;
    use constant     XCASE    => 0000004;
    use constant     ECHO     => 0000010;
    use constant     ECHOE    => 0000020;
    use constant     ECHOK    => 0000040;
    use constant     ECHONL   => 0000100;
    use constant     NOFLSH   => 0000200;
    use constant     TOSTOP   => 0000400;
    use constant     ECHOCTL  => 0001000;
    use constant     ECHOPRT  => 0002000;
    use constant     ECHOKE   => 0004000;
    use constant     FLUSHO   => 0010000;
    use constant     PENDIN   => 0040000;
    use constant     IEXTEN   => 0100000;
    use constant     EXTPROC  => 0200000;

    my ($c_iflag, $c_oflag, $c_cflag, $c_lflag) = (0, 0, 0, 0);
    $c_iflag &= ~(IXON|IXOFF|IXANY);
    $c_iflag &= ~(IGNBRK|BRKINT|PARMRK|ISTRIP|INLCR|IGNCR|ICRNL);
    $c_oflag &= ~(OPOST|OCRNL|ONLCR);
    $c_cflag &= ~(CBAUD|CBAUDEX);
    $c_cflag |= B115200;
    $c_cflag &= ~(CSIZE);
    $c_cflag |= CS8;
    $c_cflag &= ~(PARENB|CSTOPB|CRTSCTS);
    $c_cflag |= CREAD|CLOCAL;
    $c_lflag &= ~(ISIG|ICANON|ECHO|ECHOE|ECHOK|ECHONL|ECHOCTL|ECHOKE);
    my $sgttyb = pack('LLLL', $c_iflag, $c_oflag, $c_cflag, $c_lflag);
